...
#define STRING_CONFIG_H_AUTHOR "(Devin Kaiser, Ender-5 Pro)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.27, 80.21, 797.45, 96.27 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -7, -2.25 }
